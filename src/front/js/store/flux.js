const getState = ({ getStore, getActions, setStore }) => {
	return {
		...
		actions: {
			getEvents: async () => {
				try {
					const response = await fetch("https://eventicket-backend.onrender.com" + '/api/events', {
						method: 'GET',
						headers: {
			...
			getUsers: async () => {
				try {
					...
					const response = await fetch("https://eventicket-backend.onrender.com" + "/api/getusers", {
						method: "GET",
						headers: {
							"Content-Type": "application/json",
			...
			createUser: async (userData) => {
				try {
					const response = await fetch("https://eventicket-backend.onrender.com" + '/api/users', {
						method: 'POST',
						headers: {
							'Content-Type': 'application/json',
						},
			...
			deleteUser: async (userId) => {
				let adminToken = localStorage.getItem("adminToken")
				try {
					const response = await fetch(`${"https://eventicket-backend.onrender.com"}/api/users/${userId}`, {
						method: "DELETE",
						headers: {
							"Content-Type": "application/json",
							"Authorization": `Bearer ${adminToken}`
			...
			loginUser: async (email, password) => {
				try {
					const response = await fetch("https://eventicket-backend.onrender.com" + '/api/login', {
						method: 'POST',
						headers: {
							'Content-Type': 'application/json',
						},
			...
			updateUser: async (user_id, updatedData) => {
				...
				try {
					const response = await fetch(`${"https://eventicket-backend.onrender.com"}/api/users/${user_id}`, {
						method: "PUT",
						headers: {
							"Content-Type": "application/json",
			...
			loginAdmin: async (email, password) => {
				try {
					const response = await fetch("https://eventicket-backend.onrender.com" + "/api/loginadmin", {
						method: "POST",
						headers: {
							"Content-Type": "application/json"
						},
			...
			getEventById: async (eventId) => {
				...
				try {
					const response = await fetch(`${"https://eventicket-backend.onrender.com"}/api/events/${eventId}`, {
						method: "GET",
						headers: {
							"Content-Type": "application/json",
							"Authorization": `Bearer ${adminToken}`
			...
			addFavourite: async (event_id) => {
				try {
					...
					const response = await fetch("https://eventicket-backend.onrender.com" + '/api/favourites', {
						method: 'POST',
						headers: {
							'Content-Type': 'application/json',
				...
				try {
					...
					if (response.ok) {
						...
						const eventDetailsPromises = favourites.map(async (favourite) => {
							const eventResponse = await fetch("https://eventicket-backend.onrender.com" + `/api/events/${favourite.event_id}`, {
								method: "GET",
								headers: {
									"Content-Type": "application/json",
			...
			sendEmailToRecover: async (email) => {
				try {
					const data = await fetch("https://eventicket-backend.onrender.com" + '/api/recovery', {
						method: 'POST',
						headers: {
							'Content-Type': 'application/json',
						},
			...
			changepass: async (token, new_password) => {
				try {
					const data = await fetch("https://eventicket-backend.onrender.com" + '/api/changepass', {
						method: 'PUT',
						headers: {
							'Content-Type': 'application/json',
			...
			createPurchase: async (event_id, state, quantity) => {
				try {
					...
					const response = await fetch("https://eventicket-backend.onrender.com" + "/api/purchases", {
						method: "POST",
						headers: {
							"Content-Type": "application/json",
			...
			getTicketsByUser: async () => {
				try {
					const token = localStorage.getItem("access_token");
					const response = await fetch("https://eventicket-backend.onrender.com" + "/api/tickets/user", {
						method: "GET",
						headers: {
							"Content-Type": "application/json",
							Authorization: `Bearer ${token}`,
